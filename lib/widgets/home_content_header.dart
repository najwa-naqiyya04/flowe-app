...
class HomeContentHeader extends StatelessWidget {
  const HomeContentHeader({super.key, required this.selectedCategory, required this.categories, required this.onQueryChaged, required this.onCategorySelected});

  final String selectedCategory;
  final List <String> categories;
  final ValueChanged<String> onQueryChaged;
    ...
    return Padding(
      ...
      child:  Column(
        ...
        children:[
          ...
          SizedBox(height: 20,),
          SearchField(onChanged: onQueryChaged),
          SizedBox(height: 18,),
          CategoryChipList(
