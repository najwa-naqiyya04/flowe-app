              ...
              child: Stack(
                ...
                children: [
                  ...
                  Positioned(
                    top: 8,
                    left: 8,
                    child: _RatingChip(rating: flower.rating), //untuk pemanggilan rating schip
                  ),
                  //untuk handeling fav button
                  Positioned(
                    top: 6,
                    right: 6,
                    child: ValueListenableBuilder<Set<String>>(
                      valueListenable: FavoritesController.instans, //fav controller instans
                      builder: (context, favorites, _) {
                        final isFav = favorites.contains(flower.id);
                        return InkWell(
                          borderRadius: BorderRadius.circular(20),
                          onTap: () => FavoritesController.instans.toggle(flower.id), //akan memanggil FavController
                          child: CircleAvatar(
                            radius: 16,
