...
import 'package:flowee_app/widgets/quantitiy_stepper.dart';
...
class _DetailScreenState extends State<DetailScreen> {
  //nilai ini "hidup" selama widget state ini ada setiap kali di ubah lewat set state flutter akan melakukan rebuild supaya tampilan ikut terupdate
  int _quantity = 1;
  ...
  void _addToCart () {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('$_quantity x ${flower.name} di tambah ke keranjang'),
      )
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          DetailHeader(
            flower: flower, onBack: () => Navigator.of(context).pop()),
            Expanded(
              child: Container(
